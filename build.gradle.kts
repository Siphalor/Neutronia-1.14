...
dependencies {
	...
	modCompile(group = "net.fabricmc.fabric-api", name = "fabric", version = Fabric.API.version + ".+")
	include(group = "net.fabricmc.fabric-api", name = "fabric", version = Fabric.API.version + ".+")
