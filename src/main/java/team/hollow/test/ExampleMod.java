...
public class ExampleMod implements ModInitializer {
    ...
    public static final StructurePieceType TOTEM_POLE_PIECE_TYPE = Registry.register(Registry.STRUCTURE_PIECE, new Identifier(Neutronia.MOD_ID, "totem_pole"), TotemPoleGenerator.Piece::new);
    public static final StructureFeature<DefaultFeatureConfig> TOTEM_POLE_FEATURE = Registry.register(Registry.FEATURE, new Identifier(Neutronia.MOD_ID, "totem_pole"), new TotemPoleFeature());
    public static final StructureFeature<?> TOTEM_POLE_STRUCTURE = Registry.register(Registry.STRUCTURE_FEATURE, new Identifier(Neutronia.MOD_ID, "totem_pole"), TOTEM_POLE_FEATURE);
