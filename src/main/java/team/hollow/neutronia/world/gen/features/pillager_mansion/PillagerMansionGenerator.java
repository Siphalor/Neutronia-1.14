...
public class PillagerMansionGenerator {
    static {
        ...
        StructurePoolBasedGenerator.REGISTRY.add(new StructurePool(new Identifier(Neutronia.MOD_ID, "pillager_mansion/towers"), new Identifier("empty"), ImmutableList.of(Pair.of(new ListPoolElement(ImmutableList.of(new SinglePoolElement("neutronia:pillager_mansion/watchtower"), new SinglePoolElement("neutronia:pillager_mansion/watchtower_overgrown", ImmutableList.of(new BlockRotStructureProcessor(0.05F))))), 1)), StructurePool.Projection.RIGID));
    ...
    public static void addPieces(ChunkGenerator<?> chunkGenerator_1, StructureManager structureManager_1, BlockPos blockPos_1, List<StructurePiece> list_1, ChunkRandom chunkRandom_1) {
        StructurePoolBasedGenerator.addPieces(new Identifier(Neutronia.MOD_ID, "pillager_mansion"), 7, Piece::new, chunkGenerator_1, structureManager_1, blockPos_1, list_1, chunkRandom_1);
    }
    ...
    public static class Piece extends PoolStructurePiece {
        public Piece(StructureManager structureManager_1, StructurePoolElement structurePoolElement_1, BlockPos blockPos_1, int int_1, Rotation rotation_1, MutableIntBoundingBox mutableIntBoundingBox_1) {
            super(ExampleMod.PILLAGER_MANSION_PIECE, structureManager_1, structurePoolElement_1, blockPos_1, int_1 - 2, rotation_1, mutableIntBoundingBox_1);
        }
