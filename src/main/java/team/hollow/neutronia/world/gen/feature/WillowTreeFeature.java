...
public class WillowTreeFeature extends AbstractTreeFeature<DefaultFeatureConfig> {
    ...
    static {
        LOG = TreesSubModule.willow.log.getDefaultState();
        LEAVES = TreesSubModule.willow.leaves.getDefaultState();
    }
    ...
    public WillowTreeFeature(Function<Dynamic<?>, ? extends DefaultFeatureConfig> function_1, boolean boolean_1) {
        this(function_1, boolean_1, 4, LOG, LEAVES, false);
    }

    public WillowTreeFeature(Function<Dynamic<?>, ? extends DefaultFeatureConfig> function_1, boolean boolean_1, int int_1, BlockState blockState_1, BlockState blockState_2, boolean boolean_2) {
                        ...
                        for (int_20 = blockPos_1.getZ() - int_18; int_20 <= blockPos_1.getZ() + int_18; ++int_20) {
                            ...
                            if (Math.abs(int_19) != int_18 || Math.abs(int_14) != int_18 || random_1.nextInt(2) != 0 && int_9 != 0) {
                                ...
                                if (isAirOrLeaves(modifiableTestableWorld_1, blockPos_4) || isReplaceablePlant(modifiableTestableWorld_1, blockPos_4)) {
                                    this.setBlockState(modifiableTestableWorld_1, blockPos_4, this.leaves);
                                }
                            }
                        }
                    }
