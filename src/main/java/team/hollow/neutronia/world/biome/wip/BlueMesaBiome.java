...
import team.hollow.neutronia.utils.noise.PerlinNoiseGenerator;
...
public class BlueMesaBiome extends Biome {
    ...
    protected static final BlockState HARDENED_CLAY = Blocks.BLACK_TERRACOTTA.getDefaultState();
    protected static final BlockState STAINED_HARDENED_CLAY = Blocks.PURPLE_TERRACOTTA.getDefaultState();
    protected static final BlockState ORANGE_STAINED_HARDENED_CLAY = Blocks.BLUE_TERRACOTTA.getDefaultState();
    protected static final BlockState BLACK_SAND = NBlocks.BLACK_SAND.getDefaultState();
    private final boolean brycePillars;
    private final boolean hasForest;
    private BlockState[] clayBands;
    private long worldSeed;
    private PerlinNoiseGenerator pillarNoise;
    private PerlinNoiseGenerator pillarRoofNoise;
    private PerlinNoiseGenerator clayBandsOffsetNoise;

    public BlueMesaBiome(boolean brycePillars, boolean hasForest, Settings properties) {
        super(properties);
