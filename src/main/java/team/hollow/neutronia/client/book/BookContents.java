...
import team.hollow.neutronia.book.JsonUtils;
...
public class BookContents extends AbstractReadStateHolder {
	...
	public String getSubtitle() {
		...
		try {
			...
			editionStr = I18n.translate("neutronia.gui.lexicon.dev_edition");
		}

		return I18n.translate("neutronia.gui.lexicon.edition_str", editionStr);
	}
	...
	protected void findFiles(String dir, List<Identifier> list) {
		...
		JsonUtils.findFiles(mod, String.format("assets/%s/%s/%s/%s/%s", id, BookRegistry.BOOKS_LOCATION, book.resourceLoc.getPath(), DEFAULT_LANG, dir), null, pred(id, list), false, false);
	}
