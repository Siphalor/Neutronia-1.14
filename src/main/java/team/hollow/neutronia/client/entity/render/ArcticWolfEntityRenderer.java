...
import team.hollow.neutronia.client.entity.render.model.model.ModelWolfArtic;
import team.hollow.neutronia.entity.ArcticWolfEntity;

import static team.hollow.neutronia.Neutronia.MOD_ID;

public class ArcticWolfEntityRenderer extends MobEntityRenderer<ArcticWolfEntity, ModelWolfArtic<ArcticWolfEntity>> {
     ...
     */
    protected float handleRotationFloat(ArcticWolfEntity livingBase, float partialTicks) {
