...
public class VillagerEntityRenderer extends MobEntityRenderer<VillagerPlusEntity, VillagerResemblingModel<VillagerPlusEntity>> {
    private static final Identifier VILLAGER_SKIN = new Identifier("textures/entity/villager/villager.png");

    public VillagerEntityRenderer(EntityRenderDispatcher entityRenderDispatcher_1) {
        super(entityRenderDispatcher_1, new VillagerResemblingModel<>(0.0F), 0.5F);
