 ...
 */
public class ModelReceptionistVillager extends EntityModel {
    public Cuboid Head;
    public Cuboid Body;
    ...
    public ModelReceptionistVillager() {
        ...
        this.LeftLeg = new Cuboid(this, 48, 0);
        ...
        this.MiddleArm = new Cuboid(this, 28, 14);
        ...
        this.RightLeg = new Cuboid(this, 48, 0);
        ...
        this.HeadLayer = new Cuboid(this, 30, 45);
