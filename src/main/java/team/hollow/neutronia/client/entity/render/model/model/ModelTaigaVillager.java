 ...
 */
public class ModelTaigaVillager extends EntityModel {
    public Cuboid Head;
    public Cuboid Body;
    ...
    public ModelTaigaVillager() {
        ...
        this.MiddleArm = new Cuboid(this, 40, 56);
