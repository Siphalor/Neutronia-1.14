...
public class RenderBloodPhantom extends MobEntityRenderer<EntityBloodPhantom, PhantomEntityModel<EntityBloodPhantom>> {

    public static final Identifier SCORP_TEXTURE = new Identifier(Neutronia.MOD_ID + ":textures/entity/phantom/blood_phantom.png");

    public RenderBloodPhantom(EntityRenderDispatcher manager) {
