...
public class NeutroniaCornerBlock extends Block implements Waterloggable {
    ...
    static {
        ...
        NORTH_SIDING_SHAPE = NeutroniaSidingBlock.SINGLE_SHAPE_NORTH;
        EAST_SIDING_SHAPE = NeutroniaSidingBlock.SINGLE_SHAPE_EAST;
        SOUTH_SIDING_SHAPE = NeutroniaSidingBlock.SINGLE_SHAPE_SOUTH;
        WEST_SIDING_SHAPE = NeutroniaSidingBlock.SINGLE_SHAPE_WEST;
    ...
    public NeutroniaCornerBlock(BlockState blockState_1, Block.Settings block$Settings_1) {
