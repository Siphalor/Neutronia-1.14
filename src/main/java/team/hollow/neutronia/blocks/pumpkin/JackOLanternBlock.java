...
public class JackOLanternBlock extends NeutroniaBlock implements ICarvable {

    public static final DirectionProperty FACING = HorizontalFacingBlock.FACING;

    public JackOLanternBlock(Identifier identifier) {
        super(FabricBlockSettings.of(Material.PUMPKIN).hardness(1.0F).resistance(1.0F).lightLevel(15).sounds(BlockSoundGroup.WOOD));
