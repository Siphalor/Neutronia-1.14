...
public class NeutroniaGooseberryBushBlock extends PlantBlock implements Fertilizable, INeutroniaInfo {
    ...
    public NeutroniaGooseberryBushBlock() {
    ...
    public boolean activate(BlockState blockState_1, World world_1, BlockPos blockPos_1, PlayerEntity playerEntity_1, Hand hand_1, BlockHitResult blockHitResult_1) {
        ...
        if (!boolean_1 && playerEntity_1.getStackInHand(hand_1).getItem() == Items.BONE_MEAL) {
            ...
            dropStack(world_1, blockPos_1, new ItemStack(NItems.GOOSEBERRIES, int_2 + (boolean_1 ? 1 : 0)));
