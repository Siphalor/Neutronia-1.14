...
public class NeutroniaSidingBlock extends Block implements Waterloggable {
	...
	public NeutroniaSidingBlock(Block.Settings block$Settings_1) {
	...
	private static SidingType getAdjustedType(BlockView blockView, BlockPos blockPos, Direction facing) {
		...
		if(oppositeBlockState.getBlock() instanceof NeutroniaSidingBlock) {
