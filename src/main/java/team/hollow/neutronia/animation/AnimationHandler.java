package team.hollow.neutronia.animation;
...
public enum AnimationHandler {
    ...
    public <T extends Entity & IAnimatedEntity> void sendAnimationMessage(T entity, Animation animation) {
        ...
        for (PlayerEntity trackingPlayer : ((ServerWorld) entity.world).getEntityTracker().getTrackingPlayers(entity)) {
            LLibrary.NETWORK_WRAPPER.sendTo(new AnimationMessage(entity.getEntityId(), ArrayUtils.indexOf(entity.getAnimations(), animation)), (PlayerEntity) trackingPlayer);
        }
    }
