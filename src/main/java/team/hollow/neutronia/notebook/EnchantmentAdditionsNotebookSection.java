...
public class EnchantmentAdditionsNotebookSection implements NotebookSection {
    ...
    public List<NotebookElement> getElements(ClientPlayerEntity player, int page) {
        ...
        if (page == 0) {
            elements.add(new BasicNotebookElements.SmallHeading("notebook.neutronia.enchantment_additions.title").withPadding(3));
        } else {
