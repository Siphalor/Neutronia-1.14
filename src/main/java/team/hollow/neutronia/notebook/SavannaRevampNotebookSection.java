...
public class SavannaRevampNotebookSection implements NotebookSection {
    ...
    public List<NotebookElement> getElements(ClientPlayerEntity player, int page) {
        ...
        if (page == 0) {
            elements.add(new BasicNotebookElements.SmallHeading("notebook.neutronia.savanna_revamp.title").withPadding(3));
        } else {
