...
//    public static final EntityType<EntityBloodPhantom> BLOOD_PHANTOM;
    ...
    static {
        VILLAGER_PLUS = register("villager_plus", FabricEntityTypeBuilder.<VillagerPlusEntity>create(EntityCategory.CREATURE, (var1, var2) -> new VillagerPlusEntity(var2)).size(EntitySize.constant(0.6F, 1.95F)), 5651507, 12422002);
