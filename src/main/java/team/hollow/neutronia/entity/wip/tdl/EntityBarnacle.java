package team.abnormals.neutronia.entity.wip.tdl;
...
import team.abnormals.neutronia.entity.wip.EntityWaterMob;
...
public class EntityBarnacle extends EntityWaterMob {
    ...
    protected void applyEntityAttributes() {
        ...
        this.getAttributeContainer().get(EntityAttributes.MAX_HEALTH).setBaseValue(10.0D);
    }
