...
public class ServerWorldRedirectManager {
	...
	public ServerWorldRedirectManager()
	{
		...
		WorldSaveHandler worldSaveHandler_1 = storage.method_242("save", (MinecraftServer)null);
		...
		ServerWorldRedirect serverWorld_1 = new ServerWorldRedirect(server, ImmediateExecutor.INSTANCE, worldSaveHandler_1, levelProperties_1, DimensionType.OVERWORLD, (Profiler)null, worldGenerationProgressTracker_1);
		...
		DefaultResourcePack pack = new DefaultResourcePack(new String[]{"minecraft"});
		packs.add(pack);
