...
import team.hollow.neutronia.client.book.BookContents;
import team.hollow.neutronia.client.book.ExternalBookContents;
import team.hollow.neutronia.utils.ItemStackUtil;
import vazkii.neutronia.client.book.BookEntry;
import vazkii.neutronia.common.item.ItemModBook;
...
public class Book {
	...
	public static final String DEFAULT_MODEL = Neutronia.PREFIX + "book_brown";
	...
	public String bookTexture = Neutronia.PREFIX + "textures/gui/book_brown.png";
