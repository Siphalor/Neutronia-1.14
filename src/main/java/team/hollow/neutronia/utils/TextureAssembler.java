...
public class TextureAssembler {
    ...
    private Identifier medSkinMale = new Identifier(Neutronia.MOD_ID, MALE_LOCATION + "/skin/medium.png");
    private Identifier darkSkinMale = new Identifier(Neutronia.MOD_ID, MALE_LOCATION + "/skin/dark.png");
    private Identifier lightSkinFemale = new Identifier(Neutronia.MOD_ID, FEMALE_LOCATION + "/skin/light.png");
    private Identifier mediumSkinFemale = new Identifier(Neutronia.MOD_ID, FEMALE_LOCATION + "/skin/medium.png");
    ...
    private Identifier blackHairMale2 = new Identifier(Neutronia.MOD_ID, MALE_LOCATION + "/hair/black2.png");
    private Identifier blackHairMale3 = new Identifier(Neutronia.MOD_ID, MALE_LOCATION + "/hair/black3.png");
    private Identifier blackHairMale4 = new Identifier(Neutronia.MOD_ID, MALE_LOCATION + "/hair/black4.png");
    private Identifier brownHairMale = new Identifier(Neutronia.MOD_ID, MALE_LOCATION + "/hair/brown1.png");
    private Identifier brownHairMale2 = new Identifier(Neutronia.MOD_ID, MALE_LOCATION + "/hair/brown2.png");
    private Identifier brownHairMale3 = new Identifier(Neutronia.MOD_ID, MALE_LOCATION + "/hair/brown3.png");
    private Identifier brownHairMale4 = new Identifier(Neutronia.MOD_ID, MALE_LOCATION + "/hair/brown4.png");
    private Identifier blondeHairMale = new Identifier(Neutronia.MOD_ID, MALE_LOCATION + "/hair/blonde1.png");
    private Identifier blondeHairMale2 = new Identifier(Neutronia.MOD_ID, MALE_LOCATION + "/hair/blonde2.png");
    private Identifier blondeHairMale3 = new Identifier(Neutronia.MOD_ID, MALE_LOCATION + "/hair/blonde3.png");
    private Identifier blondeHairMale4 = new Identifier(Neutronia.MOD_ID, MALE_LOCATION + "/hair/blonde4.png");
    private Identifier redHairMale = new Identifier(Neutronia.MOD_ID, MALE_LOCATION + "/hair/red1.png");
    private Identifier redHairMale2 = new Identifier(Neutronia.MOD_ID, MALE_LOCATION + "/hair/red2.png");
    private Identifier redHairMale3 = new Identifier(Neutronia.MOD_ID, MALE_LOCATION + "/hair/red3.png");
    private Identifier redHairMale4 = new Identifier(Neutronia.MOD_ID, MALE_LOCATION + "/hair/red4.png");

    //Hair female
    private Identifier blondeHairFemale = new Identifier(Neutronia.MOD_ID, FEMALE_LOCATION + "/hair/blonde1.png");
    private Identifier blondeHairFemale2 = new Identifier(Neutronia.MOD_ID, FEMALE_LOCATION + "/hair/blonde2.png");
    private Identifier blondeHairFemale3 = new Identifier(Neutronia.MOD_ID, FEMALE_LOCATION + "/hair/blonde3.png");
    private Identifier blondeHairFemale4 = new Identifier(Neutronia.MOD_ID, FEMALE_LOCATION + "/hair/blonde4.png");
    private Identifier brownHairFemale = new Identifier(Neutronia.MOD_ID, FEMALE_LOCATION + "/hair/brown1.png");
    private Identifier brownHairFemale2 = new Identifier(Neutronia.MOD_ID, FEMALE_LOCATION + "/hair/brown2.png");
    private Identifier brownHairFemale3 = new Identifier(Neutronia.MOD_ID, FEMALE_LOCATION + "/hair/brown3.png");
    private Identifier brownHairFemale4 = new Identifier(Neutronia.MOD_ID, FEMALE_LOCATION + "/hair/brown4.png");
    private Identifier blackHairFemale = new Identifier(Neutronia.MOD_ID, FEMALE_LOCATION + "/hair/black1.png");
    private Identifier blackHairFemale2 = new Identifier(Neutronia.MOD_ID, FEMALE_LOCATION + "/hair/black2.png");
    private Identifier blackHairFemale3 = new Identifier(Neutronia.MOD_ID, FEMALE_LOCATION + "/hair/black3.png");
    private Identifier blackHairFemale4 = new Identifier(Neutronia.MOD_ID, FEMALE_LOCATION + "/hair/black4.png");
    private Identifier redHairFemale1 = new Identifier(Neutronia.MOD_ID, FEMALE_LOCATION + "/hair/red1.png");
    private Identifier redHairFemale2 = new Identifier(Neutronia.MOD_ID, FEMALE_LOCATION + "/hair/red2.png");
    private Identifier redHairFemale3 = new Identifier(Neutronia.MOD_ID, FEMALE_LOCATION + "/hair/red3.png");
    private Identifier redHairFemale4 = new Identifier(Neutronia.MOD_ID, FEMALE_LOCATION + "/hair/red4.png");

    private Identifier femaleBaker1 = new Identifier(Neutronia.MOD_ID, PROFESSION_LOCATION + "/female/baker1.png");
    private Identifier femaleMiner1 = new Identifier(Neutronia.MOD_ID, PROFESSION_LOCATION + "/female/miner1.png");
    private Identifier femaleMiner2 = new Identifier(Neutronia.MOD_ID, PROFESSION_LOCATION + "/female/miner2.png");
    private Identifier femaleGuard1 = new Identifier(Neutronia.MOD_ID, PROFESSION_LOCATION + "/female/guard1.png");
