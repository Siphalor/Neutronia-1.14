...
public class ImprovedOverworldTwoLevelType {
    private static final Logger LOGGER = LogManager.getLogger("ImprovedOverworldTwoType");
    ...
    public static LevelGeneratorType getType(){
        ...
        try {
            ...
            val = c.newInstance(id, "improved_overworld_two");
