package team.abnormals.neutronia.world.gen.carver;
...
public class CaveCarver extends Carver<ProbabilityConfig> {
   ...
   public boolean carve(Chunk chunk_1, Random random_1, int int_1, int int_2, int int_3, int int_4, int int_5, BitSet bitSet_1, ProbabilityConfig probabilityConfig_1) {
      ...
      for(int int_8 = 0; int_8 < int_7; ++int_8) {
         double double_1 = (double)(int_2 * 16 + random_1.nextInt(16));
         double double_2 = (double)this.getCaveY(random_1);
         double double_3 = (double)(int_3 * 16 + random_1.nextInt(16));
         int int_9 = 1;
         float float_3;
         if (random_1.nextInt(4) == 0) {
            double double_4 = 0.5D;
