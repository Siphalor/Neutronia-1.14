...
public final class BoundingBox implements Cloneable
{
    ...
    public void expandToFitChunk(ChunkPos chunk)
    {
        expandToFit(chunk.getRegionX(), 0, chunk.getRegionZ());
        expandToFit(chunk.getRegionX() + ChunkCoordinate.CHUNK_X_SIZE, ChunkCoordinate.CHUNK_Y_SIZE,
                chunk.getRegionZ() + ChunkCoordinate.CHUNK_Z_SIZE);
    }
