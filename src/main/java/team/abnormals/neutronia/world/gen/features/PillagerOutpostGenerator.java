...
public class PillagerOutpostGenerator {
    static {
        ...
        StructurePoolBasedGenerator.REGISTRY.add(new StructurePool(new Identifier(Neutronia.MODID, "pillager_outpost/towers"), new Identifier("empty"), ImmutableList.of(Pair.of(new ListPoolElement(ImmutableList.of(new SinglePoolElement("neutronia:pillager_outpost/watchtower"), new SinglePoolElement("neutronia:pillager_outpost/watchtower_overgrown", ImmutableList.of(new BlockRotStructureProcessor(0.05F))))), 1)), StructurePool.Projection.RIGID));
