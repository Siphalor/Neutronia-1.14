...
public enum MobNames
{
    ...
    CAVE_SPIDER(EntityType.CAVE_SPIDER,"cave_spider", "cavespider"),
    ...
    ELDER_GUARDIAN(EntityType.ELDER_GUARDIAN,"elder_guardian", "elderguardian"),
    ENDER_DRAGON(EntityType.ENDER_DRAGON,"ender_dragon", "enderdragon"),
    ENDERMAN(EntityType.ENDERMAN,"enderman", "enderman"),
    ENDERMITE(EntityType.ENDERMITE,"endermite", "endermite"),
    EVOKER(EntityType.EVOKER,"evocation_illager", "evocationillager", "evoker"),
    GHAST(EntityType.GHAST,"ghast", "ghast"),
    GIANT(EntityType.BLAZE,"giant", "giant", "giantzombie", "zombiegiant"),
    GUARDIAN(EntityType.BLAZE.getTranslationKey(),"guardian", "guardian"),
    HORSE("horse", "horse"),
    HUSK("husk", "husk"),
    LLAMA("llama", "llama"),
    ...
    private MobNames(EntityType entityType, String internalMinecraftName, String... aliases)
    {
