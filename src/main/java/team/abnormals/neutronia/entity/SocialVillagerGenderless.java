...
public class SocialVillagerGenderless extends SocialVillagerBase {

	public SocialVillagerGenderless(World world) {
		super(NEntityTypes.SOCIAL_VILLAGER_GENDERLESS, world);
		try {
	...
	private String generateFirstName() throws IOException
	{
		...
		Identifier names = new Identifier("neutronia:names/genderless.txt");
