...
public class SocialVillagerGenderlessRenderer extends MobEntityRenderer{

	public SocialVillagerGenderlessRenderer(EntityRenderDispatcher dispatcher)
	{
		super(dispatcher, new PlayerEntityModel(0.0F, true), 0.5F);
	}
	public SocialVillagerGenderlessRenderer(EntityRenderDispatcher entityRenderDispatcher_1, EntityModel entityModel_1,
                                            float float_1) {
	...
	protected Identifier getTexture(Entity entity) {
		...
		SocialVillagerGenderless entityIn = (SocialVillagerGenderless) entity;
		...
		BufferedImage imageBase = new TextureAssembler(eyeColor,hairColor,skinColor, hairStyle, "Genderless").createTexture();
