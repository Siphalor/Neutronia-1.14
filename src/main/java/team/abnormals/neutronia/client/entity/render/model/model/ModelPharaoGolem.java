...
public class ModelPharaoGolem extends EntityModel {
    /**
     * The head model for the iron golem.
     */
    public Cuboid ironGolemHead;
    /**
     * The body model for the iron golem.
     */
    public Cuboid ironGolemBody;
    /**
     * The right arm model for the iron golem.
     */
    public Cuboid ironGolemRightArm;
    /**
     * The left arm model for the iron golem.
     */
    public Cuboid ironGolemLeftArm;
    /**
     * The left leg model for the Iron Golem.
     */
    public Cuboid ironGolemLeftLeg;
    /**
     * The right leg model for the Iron Golem.
     */
    public Cuboid ironGolemRightLeg;
    ...
    public ModelPharaoGolem(float p_i46362_1_, float p_i46362_2_) {
        int i = 128;
        int j = 128;
        this.ironGolemHead = (new Cuboid(this)).setTextureSize(128, 128);
        ...
        this.ironGolemBody = (new Cuboid(this)).setTextureSize(128, 128);
        ...
        this.ironGolemRightLeg = (new Cuboid(this, 0, 22)).setTextureSize(128, 128);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        this.ironGolemHead.rotationPointY = netHeadYaw * 0.017453292F;
        this.ironGolemHead.rotationPointX = headPitch * 0.017453292F;
        this.ironGolemLeftLeg.rotationPointX = -1.5F * this.triangleWave(limbSwing, 13.0F) * limbSwingAmount;
        this.ironGolemRightLeg.rotationPointX = 1.5F * this.triangleWave(limbSwing, 13.0F) * limbSwingAmount;
        this.ironGolemLeftLeg.rotationPointY = 0.0F;
        this.ironGolemRightLeg.rotationPointY = 0.0F;
    }
    ...
    public void setLivingAnimations(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
        ...
        if (i > 0) {
            this.ironGolemRightArm.rotationPointX = -2.0F + 1.5F * this.triangleWave((float) i - partialTickTime, 10.0F);
            this.ironGolemLeftArm.rotationPointX = -2.0F + 1.5F * this.triangleWave((float) i - partialTickTime, 10.0F);
        } else {
            this.ironGolemRightArm.rotationPointX = (-0.2F + 1.5F * this.triangleWave(limbSwing, 13.0F)) * limbSwingAmount;
            this.ironGolemLeftArm.rotationPointX = (-0.2F - 1.5F * this.triangleWave(limbSwing, 13.0F)) * limbSwingAmount;
        }
    }
