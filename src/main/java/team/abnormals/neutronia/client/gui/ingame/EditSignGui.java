...
import team.abnormals.neutronia.blocks.BlockNeutroniaSign;
import team.abnormals.neutronia.blocks.BlockNeutroniaWallSign;
...
public class EditSignGui extends Gui {
   ...
   public  EditSignGui(SignBlockEntity signBlockEntity_1) {
   ...
   public void draw(int int_1, int int_2, float float_1) {
      ...
      if (blockState_1.getBlock().matches(BlockTags.STANDING_SIGNS)) {
         float_4 = (float)(blockState_1.get(BlockNeutroniaSign.ROTATION) * 360) / 16.0F;
      } else {
         float_4 = blockState_1.get(BlockNeutroniaWallSign.FACING).asRotation();
      }
