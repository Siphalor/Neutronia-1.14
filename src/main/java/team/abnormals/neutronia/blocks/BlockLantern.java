...
public class BlockLantern extends LanternBlock implements INeutroniaBlock {
    ...
    public BlockState getPlacementState(ItemPlacementContext itemPlacementContext_1) {
        return this.getDefaultState().with(FACING, itemPlacementContext_1.getFacing()).with(HANGING, itemPlacementContext_1.getFacing() == Direction.DOWN || itemPlacementContext_1.getWorld().getBlockState(itemPlacementContext_1.getBlockPos().up()).getBlock() instanceof BlockChain);
    }
