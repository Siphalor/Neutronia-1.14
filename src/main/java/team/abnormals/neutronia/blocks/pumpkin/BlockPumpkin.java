...
public class BlockPumpkin extends BlockModBase implements IMinecraftBlock, ICarvable {
    ...
    public ICarvable newInstance(Identifier identifier) {
        return new BlockPumpkin(identifier);
    }

    @Override
    public Block getUncarvedBlock() {
        return NBlocks.PUMPKIN;
    }
