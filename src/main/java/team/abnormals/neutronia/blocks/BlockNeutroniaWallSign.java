...
public class BlockNeutroniaWallSign extends SignBlock implements INeutroniaBlock {
        public static final DirectionProperty FACING;
    private static final Map<Direction, VoxelShape> FACING_TO_SHAPE;

    public BlockNeutroniaWallSign(String name) {
    ...
    public boolean canPlaceAt(BlockState blockState_1, ViewableWorld viewableWorld_1, BlockPos blockPos_1) {
        return viewableWorld_1.getBlockState(blockPos_1.offset(blockState_1.get(FACING).getOpposite())).getMaterial().method_15799();
    }
