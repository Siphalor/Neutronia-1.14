...
public class BlockMelon extends BlockModBase implements INeutroniaBlock, ICarvable {

    public static final DirectionProperty FACING = Properties.FACING_HORIZONTAL;

    public BlockMelon(Identifier identifier) {
    ...
    public ICarvable newInstance(Identifier identifier) {
        return new BlockMelon(identifier);
    }
