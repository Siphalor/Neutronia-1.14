...
public abstract class BlockNeutroniaPressurePlate extends PressurePlateBlock implements INeutroniaBlock {

    public BlockNeutroniaPressurePlate(String name, Material material, Type sensitivity) {
