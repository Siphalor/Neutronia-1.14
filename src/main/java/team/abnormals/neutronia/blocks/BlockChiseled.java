...
public class BlockChiseled extends BlockModBase implements INeutroniaBlock {

    public static final BooleanProperty FILLED = BooleanProperty.create("filled");
    protected Item chiselItem;

    public BlockChiseled(Material material, String name, float hardness, float resistance, Item chiselItem) {
