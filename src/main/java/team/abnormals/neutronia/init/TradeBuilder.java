...
import static team.abnormals.neutronia.init.ModVillagers.*;
...
class TradeBuilder {
    ...
    static void createRecipes() {
        VillagerTrades.PROFESSION_TO_LEVELED_TRADE.put(ARTIST, copyToFastUtilMap(ImmutableMap.of(1, new VillagerTrades.Factory[]{
                ...
                new BuyItemFactory(new ItemStack(Items.RED_BANNER), new PriceRange(18, 22)),
                new BuyItemFactory(new ItemStack(Items.GREEN_BANNER), new PriceRange(18, 22)),
                new BuyItemFactory(new ItemStack(Items.PURPLE_BANNER), new PriceRange(18, 22)),
                new BuyItemFactory(new ItemStack(Items.CYAN_BANNER), new PriceRange(18, 22)),
                new BuyItemFactory(new ItemStack(Items.LIGHT_GRAY_BANNER), new PriceRange(18, 22)),
                new BuyItemFactory(new ItemStack(Items.GRAY_BANNER), new PriceRange(18, 22)),
                new BuyItemFactory(new ItemStack(Items.PINK_BANNER), new PriceRange(18, 22)),
                new BuyItemFactory(new ItemStack(Items.LIME_BANNER), new PriceRange(18, 22)),
                new BuyItemFactory(new ItemStack(Items.YELLOW_BANNER), new PriceRange(18, 22)),
                new BuyItemFactory(new ItemStack(Items.LIGHT_BLUE_BANNER), new PriceRange(18, 22)),
                new BuyItemFactory(new ItemStack(Items.MAGENTA_BANNER), new PriceRange(18, 22)),
                new BuyItemFactory(new ItemStack(Items.ORANGE_BANNER), new PriceRange(18, 22)),
                new BuyItemFactory(new ItemStack(Items.BLUE_BANNER), new PriceRange(18, 22)),
                new BuyItemFactory(new ItemStack(Items.BROWN_BANNER), new PriceRange(18, 22)),
                new BuyItemFactory(new ItemStack(Items.BLACK_BANNER), new PriceRange(18, 22)),
