...
public class NEntityTypes {
    ...
    private static FabricEntityTypeBuilder<SocialVillager> builder = FabricEntityTypeBuilder.create(EntityCategory.CREATURE, SocialVillager::new).size(0.5F, 1.95f).trackable(64, 3);
    public static final EntityType<SocialVillager> SOCIAL_VILLAGER = Registry.register(Registry.ENTITY_TYPE,"neutronia:social_villager", builder.build());
